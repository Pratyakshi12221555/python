...
def widthdraw_cash():
    while True:
        ...
        if amount > user['balance']:
            ...
            print(f"{amount} Rupees successfully widthdrawn your remaining balance is {user['balance']}₹")
            print('')
            return False
def balance_enquiry():
...
print('')
print("Welcome Mr. john to the LPU ATM")
...
print("THANK YOU FOR VISITING LPU ATM ..... VISIT AGAIN")
